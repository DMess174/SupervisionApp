...
namespace Supervision.ViewModels.EntityViewModels.DetailViewModels.WeldGateValve
{
    public class CompactGateValveCaseEditVM : ViewModelBase
    {
        ...
        private IList<SideWall> sideWalls;
        private SideWall selectedSideWall;
        private SideWall selectedSideWallFromList;
        private IEnumerable<string> drawings;
        private IEnumerable<CompactGateValveCaseTCP> points;
        private IEnumerable<Inspector> inspectors;
        private IEnumerable<CompactGateValveCaseJournal> assemblyJournal;
        private IEnumerable<CompactGateValveCaseJournal> mechanicalJournal;
        private IEnumerable<CompactGateValveCaseJournal> nDTJournal;
        private readonly BaseTable parentEntity;
        private readonly CompactGateValveCaseRepository repo;
        ...
        private CompactGateValveCase selectedItem;
        private CompactGateValveCaseTCP selectedTCPPoint;
        private CompactGateValveCaseJournal operation;

        public CompactGateValveCaseJournal Operation
        {
            get => operation;
            set
            {
        ...
        public CompactGateValveCase SelectedItem
        {
            get => selectedItem;
            set
            {
        ...
        public IEnumerable<CompactGateValveCaseJournal> AssemblyJournal
        {
            get => assemblyJournal;
            set
            {
        ...
        public IEnumerable<CompactGateValveCaseJournal> MechanicalJournal
        {
        ...
        public IEnumerable<CompactGateValveCaseJournal> NDTJournal
        {
            get => nDTJournal;
            set
            {
        ...
        public IEnumerable<CompactGateValveCaseTCP> Points
        {
            get => points;
            set
            {
        ...
        public IList<FrontWall> FrontWalls
        {
            get => frontWalls;
            set
            {
        ...
        public IList<SideWall> SideWalls
        {
            get => sideWalls;
            set
            {
        ...
        public IList<CaseEdge> CaseEdges
        {
            get => caseEdges;
            set
            {
        ...
        public CompactGateValveCaseTCP SelectedTCPPoint
        {
        ...
        {
            if (repo.HasChanges(SelectedItem) || repo.HasChanges(SelectedItem.CompactGateValveCaseJournals))
            {
        ...
        public async Task Load(int id)
        {
            try
            {
                ...
                AssemblyJournal = SelectedItem.CompactGateValveCaseJournals.Where(i => i.EntityTCP.OperationType.Name == "Сборка/Сварка").OrderBy(x => x.PointId);
                MechanicalJournal = SelectedItem.CompactGateValveCaseJournals.Where(i => i.EntityTCP.OperationType.Name == "Механическая обработка").OrderBy(x => x.PointId);
                NDTJournal = SelectedItem.CompactGateValveCaseJournals.Where(i => i.EntityTCP.OperationType.Name == "Неразрушающий контроль").OrderBy(x => x.PointId);
            }
            finally
            {
                IsBusy = false;
        ...
        public async Task AddJournalOperation()
        {
            ...
            {
                SelectedItem.CompactGateValveCaseJournals.Add(new CompactGateValveCaseJournal(SelectedItem, SelectedTCPPoint));
        ...
        private async Task RemoveOperation()
        {
            try
            {
                ...
                if (Operation != null)
                {
                    ...
                    if (result == MessageBoxResult.Yes)
                    {
                        SelectedItem.CompactGateValveCaseJournals.Remove(Operation);
                        await SaveItemCommand.ExecuteAsync();
                        AssemblyJournal = SelectedItem.CompactGateValveCaseJournals.Where(i => i.EntityTCP.OperationType.Name == "Сборка/Сварка").OrderBy(x => x.PointId);
                        MechanicalJournal = SelectedItem.CompactGateValveCaseJournals.Where(i => i.EntityTCP.OperationType.Name == "Механическая обработка").OrderBy(x => x.PointId);
                        NDTJournal = SelectedItem.CompactGateValveCaseJournals.Where(i => i.EntityTCP.OperationType.Name == "Неразрушающий контроль").OrderBy(x => x.PointId);
        ...
        public static CompactGateValveCaseEditVM LoadVM(int id, BaseTable entity, DataContext context)
        {
            CompactGateValveCaseEditVM vm = new CompactGateValveCaseEditVM(entity, context);
            vm.LoadItemCommand.ExecuteAsync(id);
            return vm;
        }

        public CompactGateValveCaseEditVM(BaseTable entity, DataContext context)
        {
            db = context;
            parentEntity = entity;
            repo = new CompactGateValveCaseRepository(db);
