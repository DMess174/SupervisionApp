...
{
    public class CompactGateValveCoverEditVM : ViewModelBase
    {
        ...
        private IEnumerable<CompactGateValveCoverTCP> points;
        private IEnumerable<Inspector> inspectors;
        private IEnumerable<CompactGateValveCoverJournal> assemblyJournal;
        private IEnumerable<CompactGateValveCoverJournal> assemblyWeldingJournal;
        private IEnumerable<CompactGateValveCoverJournal> mechanicalJournal;
        private IEnumerable<CompactGateValveCoverJournal> nDTJournal;
        ...
        private CompactGateValveCoverTCP selectedTCPPoint;
        private CompactGateValveCoverJournal operation;

        public CompactGateValveCoverJournal Operation
        {
            get => operation;
            set
            {
        ...
        public IEnumerable<CompactGateValveCoverJournal> AssemblyWeldingJournal
        {
        ...
        public IEnumerable<CompactGateValveCoverJournal> MechanicalJournal
        {
        ...
        public IEnumerable<CompactGateValveCoverJournal> NDTJournal
        {
            get => nDTJournal;
            set
            {
        ...
        public IEnumerable<CompactGateValveCoverJournal> AssemblyJournal
        {
            get => assemblyJournal;
            set
            {
        ...
        public IEnumerable<CompactGateValveCoverTCP> Points
        {
            get => points;
            set
            {
        ...
        public CompactGateValveCoverTCP SelectedTCPPoint
        {
        ...
        public static CompactGateValveCoverEditVM LoadVM(int id, BaseTable entity, DataContext context)
        {
            CompactGateValveCoverEditVM vm = new CompactGateValveCoverEditVM(entity, context);
        ...
        public async Task Load(int id)
        {
            try
            {
                ...
                AssemblyWeldingJournal = SelectedItem.CompactGateValveCoverJournals.Where(i => i.EntityTCP.OperationType.Name == "Сборка/Сварка").OrderBy(x => x.PointId);
                MechanicalJournal = SelectedItem.CompactGateValveCoverJournals.Where(i => i.EntityTCP.OperationType.Name == "Механическая обработка").OrderBy(x => x.PointId);
                NDTJournal = SelectedItem.CompactGateValveCoverJournals.Where(i => i.EntityTCP.OperationType.Name == "Неразрушающий контроль").OrderBy(x => x.PointId);
                AssemblyJournal = SelectedItem.CompactGateValveCoverJournals.Where(i => i.EntityTCP.OperationType.Name == "Сборка").OrderBy(x => x.PointId);
            }
            finally
            {
                IsBusy = false;
        ...
        public async Task AddJournalOperation()
        {
            ...
            {
                SelectedItem.CompactGateValveCoverJournals.Add(new CompactGateValveCoverJournal(SelectedItem, SelectedTCPPoint));
        ...
        private async Task RemoveOperation()
        {
            try
            {
                ...
                if (Operation != null)
                {
                    ...
                    {
                        SelectedItem.CompactGateValveCoverJournals.Remove(Operation);
                        await SaveItemCommand.ExecuteAsync();
                        AssemblyWeldingJournal = SelectedItem.CompactGateValveCoverJournals.Where(i => i.EntityTCP.OperationType.Name == "Сборка/Сварка").OrderBy(x => x.PointId);
                        MechanicalJournal = SelectedItem.CompactGateValveCoverJournals.Where(i => i.EntityTCP.OperationType.Name == "Механическая обработка").OrderBy(x => x.PointId);
                        NDTJournal = SelectedItem.CompactGateValveCoverJournals.Where(i => i.EntityTCP.OperationType.Name == "Неразрушающий контроль").OrderBy(x => x.PointId);
        ...
        {
            if (repo.HasChanges(SelectedItem) || repo.HasChanges(SelectedItem.CompactGateValveCoverJournals))
            {
        ...
        public CompactGateValveCoverEditVM(BaseTable entity, DataContext context)
        {
            db = context;
            parentEntity = entity;
