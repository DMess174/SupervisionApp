...
{
    public class WeldNozzleEditVM : ViewModelBase
    {
        ...
        private WeldNozzleJournal operation;
        ...
        public WeldNozzleJournal Operation
        {
            get => operation;
            set
            {
        ...
        public static WeldNozzleEditVM LoadVM(int id, BaseTable entity, DataContext context)
        {
            WeldNozzleEditVM vm = new WeldNozzleEditVM(entity, context);
        ...
        public async Task AddJournalOperation()
        {
            ...
            {
                SelectedItem.WeldNozzleJournals.Add(new WeldNozzleJournal(SelectedItem, SelectedTCPPoint));
        ...
        private async Task RemoveOperation()
        {
            try
            {
                if (Operation != null)
                {
                    ...
                    {
                        IsBusy = true;
                        SelectedItem.WeldNozzleJournals.Remove(Operation);
                        await SaveItemCommand.ExecuteAsync();
                    }
                }
        ...
        {
            if (repo.HasChanges(SelectedItem) || repo.HasChanges(SelectedItem.WeldNozzleJournals))
            {
        ...
        public WeldNozzleEditVM(BaseTable entity, DataContext context)
        {
            db = context;
            parentEntity = entity;
