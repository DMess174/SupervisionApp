...
{
    public class CaseFlangeEditVM : ViewModelBase
    {
        ...
        private CaseFlangeJournal operation;
        private CaseFlange selectedItem;
        private CaseFlangeTCP selectedTCPPoint;
        private readonly CaseFlangeRepository repo;
        ...
        public CaseFlangeJournal Operation
        {
            get => operation;
            set
            {
        ...
        public static CaseFlangeEditVM LoadVM(int id, BaseTable entity, DataContext context)
        {
            CaseFlangeEditVM vm = new CaseFlangeEditVM(entity, context);
        ...
        public async Task AddJournalOperation()
        {
            ...
            {
                SelectedItem.CaseFlangeJournals.Add(new CaseFlangeJournal(SelectedItem, SelectedTCPPoint));
        ...
        private async Task RemoveOperation()
        {
            try
            {
                ...
                if (Operation != null)
                {
                    ...
                    {
                        SelectedItem.CaseFlangeJournals.Remove(Operation);
                        await SaveItemCommand.ExecuteAsync();
                    }
                }
        ...
        {
            if (repo.HasChanges(SelectedItem) || repo.HasChanges(SelectedItem.CaseFlangeJournals))
            {
        ...
        public CaseFlangeEditVM(BaseTable entity, DataContext context)
        {
            db = context;
            parentEntity = entity;
            repo = new CaseFlangeRepository(db);
