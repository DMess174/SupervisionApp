...
{
    public class SideWallEditVM: BasePropertyChanged
    {
        ...
        private IEnumerable<SideWallJournal> journal;
        ...
        public IEnumerable<SideWallJournal> Journal
        {
            get => journal;
            set
            {
            ...
            get
            {
                return saveItem ?? (
                    saveItem = new DelegateCommand(() =>
                    {
                        ...
                        {
                            db.SideWalls.Update(SelectedItem);
                            db.SaveChanges();
                            ...
                            db.SideWallJournals.UpdateRange(Journal);
                            db.SaveChanges();
                        }
        ...
        public ICommand CloseWindow
        {
            get
            {
                return closeWindow ?? (
                    ...
                    {
                        if (parentEntity is SideWall)
                        {
                            var wn = new SideWallView();
        ...
        public SideWallEditVM(int id, BaseTable entity)
        {
            parentEntity = entity;
            db = new DataContext();
            ...
            Points = db.Set<SideWallTCP>().ToList();
        }
    }
}
