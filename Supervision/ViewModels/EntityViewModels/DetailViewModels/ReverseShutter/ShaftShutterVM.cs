...
{
    public class ShaftShutterVM : ViewModelBase
    {
        private readonly DataContext db;
        private IList<ShaftShutter> allInstances;
        ...
        public string Number
        {
            ...
            set
            {
                ...
                {
                    if (obj is ShaftShutter item && item.Number != null)
                    {
        ...
        public string Drawing
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ShaftShutter item && item.Drawing != null)
                    {
        ...
        public string Status
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ShaftShutter item && item.Status != null)
                    {
        ...
        public string Material
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ShaftShutter item && item.MetalMaterial.Material != null)
                    {
        ...
        public string Melt
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ShaftShutter item && item.MetalMaterial.Melt != null)
                    {
        ...
        public string Certificate
        {
            ...
            set
            {
                ...
                allInstancesView.Filter += (obj) =>
                {
                    if (obj is ShaftShutter item && item.MetalMaterial.Certificate != null)
                    {
        ...
        public IList<ShaftShutter> AllInstances
        {
            get => allInstances;
            set
            {
        ...
        public static ShaftShutterVM LoadVM(DataContext context)
        {
            ShaftShutterVM vm = new ShaftShutterVM(context);
        ...
        private async Task UpdateList()
        {
            ...
            {
                IsBusy = true;
                AllInstances = new ObservableCollection<ShaftShutter>();
        ...
        private async Task AddNewItem()
        {
            ...
            {
                IsBusy = true;
                SelectedItem = await repo.AddAsync(new ShaftShutter());
                var tcpPoints = await repo.GetTCPsAsync();
                var records = new List<ShaftShutterJournal>();
                foreach (var tcp in tcpPoints)
                {
                    var journal = new ShaftShutterJournal(SelectedItem, tcp);
                    if (journal != null)
                        records.Add(journal);
                }
        ...
        private async Task CopySelectedItem()
        {
            if (SelectedItem != null)
            {
                try
                {
                    ...
                    var copy = await repo.AddAsync(new ShaftShutter(temp));
                    var jour = new ObservableCollection<ShaftShutterJournal>();
                    foreach (var i in temp.ShaftShutterJournals)
                    {
                        var record = new ShaftShutterJournal(copy.Id, i);
                        jour.Add(record);
                    }
        ...
        private void EditSelectedItem()
        {
            if (SelectedItem != null)
            {
                ...
                {
                    DataContext = ShaftShutterEditVM.LoadVM(SelectedItem.Id, SelectedItem, db)
                };
            }
        ...
        public ShaftShutterVM(DataContext context)
        {
            db = context;
