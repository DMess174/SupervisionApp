    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssemblyUnitSealingTCPs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountUsed = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BallValveTCP", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FrontalSaddleSealingTCPs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScrewNutTCPs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScrewStudTCPs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShearPinTCPs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpringTCPs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssemblyUnitSealingJournals_AssemblyUnitSealingTCPs_PointId",
                        column: x => x.PointId,
                        principalTable: "AssemblyUnitSealingTCPs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FrontalSaddleSealingJournals_FrontalSaddleSealingTCPs_PointId",
                        column: x => x.PointId,
                        principalTable: "FrontalSaddleSealingTCPs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScrewNutJournals_ScrewNutTCPs_PointId",
                        column: x => x.PointId,
                        principalTable: "ScrewNutTCPs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScrewStudJournals_ScrewStudTCPs_PointId",
                        column: x => x.PointId,
                        principalTable: "ScrewStudTCPs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SpringJournals_SpringTCPs_PointId",
                        column: x => x.PointId,
                        principalTable: "SpringTCPs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BallValve", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BallValve_BaseValve_BaseValveId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BallValveJournal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BallValveJournal_BallValve_DetailId",
                        column: x => x.DetailId,
                        principalTable: "BallValve",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BallValveJournal_Inspectors_InspectorId",
                        column: x => x.InspectorId,
                        principalTable: "Inspectors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BallValveJournal_BallValveTCP_PointId",
                        column: x => x.PointId,
                        principalTable: "BallValveTCP",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShearPinJournals_ShearPinTCPs_PointId",
                        column: x => x.PointId,
                        principalTable: "ShearPinTCPs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BallValve_BaseValveId",
                table: "BallValve",
                column: "BaseValveId");

            migrationBuilder.CreateIndex(
                name: "IX_BallValveJournal_DetailId",
                table: "BallValveJournal",
                column: "DetailId");

            migrationBuilder.CreateIndex(
                name: "IX_BallValveJournal_InspectorId",
                table: "BallValveJournal",
                column: "InspectorId");

            migrationBuilder.CreateIndex(
                name: "IX_BallValveJournal_PointId",
                table: "BallValveJournal",
                column: "PointId");
